                ...
                <Form.Group as={Row}>
                  ...
                  <Col sm={5}>
                    ...
                    <Form.Control as="select" value ={this.state.serv} onChange = {this.handleServ} defaultValue="">
                      ...
                      <option value ="oilChange">$400 - Tinted Windows</option>
                      <option value ="flatTire">$800 - Exhaust Modification</option>
                      <option value ="paintTouchUp">$1200 - Full Car Wrap</option>
                      <option value ="engineRepair">$3000 - Full Engine Tune</option>
                    </Form.Control>
                  </Form.Group>
                  </Col>
                </Form.Group>
